        ...
        for tab in tabs:
            ...
            for cell in cells:
                ...
                if (
                    ...
                    or value_type
                    not in {"formula", "boolean", "number", "date", "text"}
                    ...
                    or style["fill"] is not None
                    and not isinstance(style["fill"], str)
                    or style["align"] is not None
                    and not isinstance(style["align"], str)
