...
import { api as request, type ModelInventory, type ModelReadiness, type WorksheetCell, type WorksheetResponse, type WorksheetTab } from "../../lib/api";
    ...
    try {
      ...
      if (nextBuild?.status === "READY") {
        const [registryResponse, revisionResponse] = await Promise.all([
          request<AssumptionRegistry>(`/api/cases/${expectedCaseId}/models/assumption-registry?build_id=${encodeURIComponent(nextBuild.id)}`, {}, signal),
