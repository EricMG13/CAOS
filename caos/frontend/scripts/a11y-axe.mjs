  ...
  const runFixture = {
    ...
    research: {
      ...
      proposed_plan: {
        ...
        upstream_artifacts: [{ module_id: "CP-0", artifact_id: "art_a11y", digest: "artifact-digest" }],
        scope: { type: "issuer", key: "case-a11y-pending-plan", source_mode: "supplied_only" },
        workstreams: [{ id: "WS-1", kind: "topical", question: "Can the issuer refinance?", assigned_questions: ["Liquidity runway?"], perspective: "Buy-side credit analyst", hypothesis: "Liquidity supports refinancing.", evidence_needs: ["Debt maturity schedule"], source_classes: ["supplied_case_sources"], disconfirming_test: "Find contrary supplied evidence.", completion_test: "Answer with source locators or record the gap.", effort_cap: "Within the fixed standard research budget." }],
      },
    },
  };
