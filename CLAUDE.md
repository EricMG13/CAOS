...
This project is indexed by GitNexus as **CAOS** (5552 symbols, 19793 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
