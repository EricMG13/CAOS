...
This project is indexed by GitNexus as **CAOS** (5721 symbols, 20459 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
